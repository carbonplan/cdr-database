    ...
    <Layout>
      <Box sx={{}}>
        ...
        <Text sx={{ maxWidth: '800px', fontSize: [3] }}>
          Descriptions of our metrics and notes on each carbon removal project we have analyzed.
          Check out the <Link onClick={() => setSection('feedback')}>feedback</Link> section if you
