  ...
  return (
    <Box>
      ...
      <Box sx={{ display: ['none', 'none', 'inherit'] }}>
        ...
        >
          <Grid id="grid" gap={['16px']} columns={['85px 100px 1fr 110px 30px']}>
            <Text
              variant="metric.value"
              sx={{
                color: theme.tags[tag],
            ...
            <Box>
              {metric.name == 'mechanism' && (
                <Emissions tag={tag} removal={metric.removal} avoided={metric.avoided}></Emissions>
              )}
              {metric.name == 'volume' && (
                <Bar tag={tag} data={metric.value} scale={scales['volume']}></Bar>
              )}
              {metric.name == 'permanence' && (
                <Bar tag={tag} data={metric.value} scale={scales['permanence']}></Bar>
              )}
              {metric.name == 'negativity' && (
                <Bar tag={tag} data={metric.value} scale={scales['negativity']}></Bar>
              )}
              {metric.name == 'cost' && (
        ...
        {expanded && (
          ...
          >
            {metric.notes && (
              <Grid gap={['16px']} columns={['201px 1fr 30px']} sx={{}}>
                <Text
                  variant="metric.comment"
                  sx={{
                    color: theme.tags[tag],
