  ...
  return (
    ...
    >
      <Grid columns={[1, null, '1fr 30px']}>
        <Box>
          <Badge variant="primary" sx={getStyle('forests')} onClick={() => addOrRemove('forests')}>
            forests
          </Badge>
          <Badge variant="primary" sx={getStyle('dac')} onClick={() => addOrRemove('dac')}>
            dac
          </Badge>
          <Badge
            variant="primary"
          ...
          <Badge variant="primary" sx={getStyle('soil')} onClick={() => addOrRemove('soil')}>
            soil
          </Badge>
          <Badge variant="primary" sx={getStyle('ocean')} onClick={() => addOrRemove('ocean')}>
            ocean
          </Badge>
          <Badge variant="primary" sx={getStyle('biomass')} onClick={() => addOrRemove('biomass')}>
            biomass
          </Badge>
          <Badge variant="primary" sx={getStyle('all')} onClick={() => toggleAll()}>
            all
          </Badge>
        </Box>
      ...
      <Grid columns={[2, null, '1fr 200px']}>
        <Box></Box>
        <Box sx={{ pr: [1] }}>{searchExpanded && <Search />}</Box>
      </Grid>
    </Box>
  )
}
