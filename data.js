      ...
      metrics: [
        {
          ...
          comment:
            'Multiple established soil carbon removal pathways exist, including five referenced in the Nori Croplands methodlogy (Section 2.3 of Version 1.1). Validating specific removal mechanisms would require more project details.',
          removal: 1.0,
          avoided: 0.0,
        },
        {
          ...
          comment:
            'Project locations are specified and COMET-Farm is a publicly available tool. Validating individual volumes would require knowing at least which practices will be applied at project sites, model parameters used, or more complete plot details.',
        },
        {
          type: 'Metric',
          name: 'negativity',
    ...
    },
    {
      ...
      metrics: [
        ...
        },
        {
          ...
          notes: '',
          comment:
            'Competing uses of bio-oil assumed to be burning for energy. Further analysis would require more information on competing uses. Some possibility that procurement of bio-oil will expand production.',
        },
        {
          type: 'Metric',
          name: 'cost',
