module.exports = {
  ...
  projects: [
    ...
    },
    {
      ...
      location: { name: 'Pennsylvania, USA', geometry: { type: null } },
      source: {
        name: 'Microsoft 2021 CDR RFP',
        license: 'CC-BY-4.18',
        url: 'https://www.microsoft.com/en-us/',
    ...
    {
      type: 'Project',
      name: 'Lake Albert Region Reforestation',
      metrics: [
        {
          type: 'Metric',
          name: 'mechanism',
    ...
    },
    {
      ...
      location: { name: 'Sweden', geometry: { type: null } },
      source: {
        name: 'Microsoft 2021 CDR RFP',
        license: 'CC-BY-4.21',
        url: 'https://www.microsoft.com/en-us/',
    ...
    },
    {
      ...
      applicant: 'Biorecro AB',
      location: { name: 'IL, USA', geometry: { type: null } },
      source: {
        name: 'Microsoft 2021 CDR RFP',
        license: 'CC-BY-4.22',
        url: 'https://www.microsoft.com/en-us/',
    ...
    {
      type: 'Project',
      name: 'West Texas Direct Air Capture',
      metrics: [
        {
          type: 'Metric',
          name: 'mechanism',
          ...
          rating: 0.0,
          notes:
            'Removes carbon from the atmosphere using a liquid solvent. Captured carbon dioxide is either stored via geologic injection or is used for enhanced oil recovery.',
          comment:
            'Opacity regarding the fate of captured CO2 prevents us from validating this mechanism.',
          removal: 1.0,
          avoided: 0.0,
        },
        {
      ...
      location: { name: 'Texas, USA', geometry: { type: null } },
      source: {
        name: 'Microsoft 2021 CDR RFP',
        license: 'CC-BY-4.23',
        url: 'https://www.microsoft.com/en-us/',
    ...
    {
      type: 'Project',
      name: 'Hawai\u02bbi Pathfinder Reforestation',
      metrics: [
        {
          type: 'Metric',
          name: 'mechanism',
      ...
      applicant: 'Terraformation Inc.',
      location: { name: 'Hawaii, USA', geometry: { type: null } },
      source: {
        name: 'Microsoft 2021 CDR RFP',
        license: 'CC-BY-4.28',
        url: 'https://www.microsoft.com/en-us/',
    ...
    {
      type: 'Project',
      name: 'Palouse Low Disturbance Cropping',
      metrics: [
        {
          type: 'Metric',
          name: 'mechanism',
    ...
    {
      type: 'Project',
      name: 'Paroo River North Assisted Regeneration',
      metrics: [
        {
          type: 'Metric',
          name: 'mechanism',
    ...
    {
      type: 'Project',
      name: 'Norley Assisted Regeneration Project',
      metrics: [
        {
          type: 'Metric',
          name: 'mechanism',
    ...
    {
      type: 'Project',
      name: 'Massachusetts Tri-City IFM',
      metrics: [
        {
          type: 'Metric',
          name: 'mechanism',
      ...
      applicant: 'Blue Source LLC',
      location: { name: 'Mississippi, USA', geometry: { type: null } },
      source: {
        name: 'Microsoft 2021 CDR RFP',
        license: 'CC-BY-4.37',
        url: 'https://www.microsoft.com/en-us/',
    ...
    {
      type: 'Project',
      name: 'Gold Standard Fast Track to Soil Organic Carbon CDR',
      metrics: [
        {
          type: 'Metric',
          name: 'mechanism',
        ...
        },
        {
          ...
          notes: '',
          comment:
            'No information or data on specific projects are publicly available, and methods are either still in development.',
        },
      ],
      geometry: { type: null },
      tags: ['soil'],
    ...
    {
      type: 'Project',
      name: 'Unlocking Future CDR Supply',
      metrics: [
        {
          type: 'Metric',
          name: 'mechanism',
    ...
    {
      type: 'Project',
      name: 'Xiguan Afforestation Project',
      metrics: [
        {
          type: 'Metric',
          name: 'mechanism',
    ...
    {
      type: 'Project',
      name: 'CDR Procurement via CAR Soil Enrichment Protocol',
      metrics: [
        {
          type: 'Metric',
          name: 'mechanism',
    ...
    {
      type: 'Project',
      name: 'Corteva Agriscience Scalable Soil Carbon Sequestration',
      metrics: [
        {
          type: 'Metric',
          name: 'mechanism',
    ...
    },
    {
      ...
      applicant: 'Blue Source LLC',
      location: { name: 'New Mexico, USA', geometry: { type: null } },
      source: {
        name: 'Microsoft 2021 CDR RFP',
        license: 'CC-BY-4.51',
        url: 'https://www.microsoft.com/en-us/',
    ...
    {
      type: 'Project',
      name: 'Qianxinan Afforestation Project',
      metrics: [
        {
          type: 'Metric',
          name: 'mechanism',
    ...
    {
      type: 'Project',
      name: 'Sierra Leone Reforestation',
      metrics: [
        {
          type: 'Metric',
          name: 'mechanism',
    ...
    },
    {
      ...
      metrics: [
        ...
        },
        {
          ...
          notes: 'No counterfactual is specified.',
          comment:
            'More information about the baseline and project harvest scenarios used to credit the project would be needed to verify additionality. Special attention should be to the claimed baseline in the context of ongoing land use.',
        },
        {
          type: 'Metric',
          name: 'cost',
      ...
      applicant: 'Blue Source LLC',
      location: { name: 'Michigan, USA', geometry: { type: null } },
      source: {
        name: 'Microsoft 2021 CDR RFP',
        license: 'CC-BY-4.57',
        url: 'https://www.microsoft.com/en-us/',
    ...
    {
      type: 'Project',
      name: 'Ghana Forest Reserve Reforestation',
      metrics: [
        {
          type: 'Metric',
          name: 'mechanism',
    ...
    {
      type: 'Project',
      name: 'Forever Wild Carbon Aggregation Initiative',
      metrics: [
        {
          type: 'Metric',
          name: 'mechanism',
      ...
      location: { name: 'Vermont, USA', geometry: { type: null } },
      source: {
        name: 'Microsoft 2021 CDR RFP',
        license: 'CC-BY-4.59',
        url: 'https://www.microsoft.com/en-us/',
    ...
    {
      type: 'Project',
      name: 'Kibale National Park Forest Rehabilitation',
      metrics: [
        {
          type: 'Metric',
          name: 'mechanism',
    ...
    },
    {
      ...
      location: { name: 'United Kingdom', geometry: { type: null } },
      source: {
        name: 'Microsoft 2021 CDR RFP',
        license: 'CC-BY-4.65',
        url: 'https://www.microsoft.com/en-us/',
    ...
    },
    {
      ...
      applicant: 'Native, a Public Benefit Corporation',
      location: { name: 'Montana, USA', geometry: { type: null } },
      source: {
        name: 'Microsoft 2021 CDR RFP',
        license: 'CC-BY-4.69',
        url: 'https://www.microsoft.com/en-us/',
      ...
      metrics: [
        {
          ...
          notes: '',
          comment:
            'Project appears to include a wide range of activities on agricultural lands, including reforestation, improvement of natural features, and modifying agricultural practices. Validating project mechanisms would require specific project details, which are not available.',
          removal: 1.0,
          avoided: 1.0,
        },
        {
          ...
          rating: 0.0,
          notes:
            'Seller offers 1,050,000 tCO2 removal from a 107,800 acre project area. Project maintains a 15% risk buffer to mitigate against reversals.',
          comment:
            'Validation of volume would at a minimum require information on specific projects, and documentation of methodology used to calculate removal volume.',
        },
        {
        ...
        },
        {
          ...
          notes: 'Seller claims 10 year permanence.',
          comment:
            'Soil carbon storage can last for decades or more, but it can also be reversed by changes to land use or management practices. No information is provided as to the contract terms with participating farmers.',
        },
        {
          type: 'Metric',
          name: 'additionality',
    ...
    {
      type: 'Project',
      name: 'Yara Agricultural Soil Carbon',
      metrics: [
        {
          type: 'Metric',
          name: 'mechanism',
    ...
    {
      type: 'Project',
      name: 'Honduras Community Reforestation and Agroforestry',
      metrics: [
        {
          type: 'Metric',
          name: 'mechanism',
    ...
    {
      type: 'Project',
      name: 'Pointe-aux-Chenes Wildlife Management Area',
      metrics: [
        {
          type: 'Metric',
          name: 'mechanism',
    ...
    {
      type: 'Project',
      name: 'Espirito Santo Carbon Program',
      metrics: [
        {
          type: 'Metric',
          name: 'mechanism',
    ...
    {
      type: 'Project',
      name: 'Fort Peck and Fort Belknap Reservations Bison Restoration ',
      metrics: [
        {
          type: 'Metric',
          name: 'mechanism',
    ...
    {
      type: 'Project',
      name: 'Brazil Multi-Species Reforestation',
      metrics: [
        {
          type: 'Metric',
          name: 'mechanism',
    ...
    },
    {
      ...
      applicant: 'Nori INC',
      location: { name: 'Iowa, USA', geometry: { type: null } },
      source: {
        name: 'Microsoft 2021 CDR RFP',
        license: 'CC-BY-4.88',
        url: 'https://www.microsoft.com/en-us/',
    ...
    },
    {
      ...
      metrics: [
        ...
        },
        {
          ...
          rating: 0.0,
          notes:
            'Seller offers 600,000 tCO2 removal from an unknown project area. A buffer pool will be maintained to mitigate against reversals following the ACR methodology.',
          comment:
            'There is not enough information to validate this volume. See Specificity comment.',
        },
        {
    ...
    {
      type: 'Project',
      name: 'Heilongjiang Province Reforestation',
      metrics: [
        {
          type: 'Metric',
          name: 'mechanism',
    ...
    },
    {
      ...
      description:
        'Cumberland Forest Project, Improved Forest Management in a Biodiversity Hotspot',
      applicant: 'The Nature Conservancy',
      location: { name: 'Tennessee & KY, USA', geometry: { type: null } },
      source: {
        name: 'Microsoft 2021 CDR RFP',
        license: 'CC-BY-4.10',
        url: 'https://www.microsoft.com/en-us/',
    ...
    {
      type: 'Project',
      name: 'Clinch Valley Conservation Forestry Program \u2013 Clifton Farm',
      metrics: [
        {
          type: 'Metric',
          name: 'mechanism',
    ...
    },
    {
      ...
      metrics: [
        {
          ...
          rating: 0.0,
          notes:
            'Avoids emissions from a waste recovery facility, and instead captures it for storage via mineralization or geologic injection.',
          comment:
            "Project seeks to add carbon capture and storage to an unspecified Energy Recovery Center. From a narrow lifecycle perspective, project only avoids CO2 emissions. From a broad perspective, the same mechanism forms a carbon removal pathway when coupled to biomass production. More project specifics would be needed to verify this proposal's mechanism.",
          removal: 0.0,
          avoided: 1.0,
        },
        {
          ...
          rating: 0.0,
          notes:
            'Seller offers 1,200,000 tCO2 removal from the addition of CCS to an unspecified facility, operated from 2027 onward.',
        ...
        },
        {
          ...
          notes: '',
          comment:
            'Negativity is a key parameter for evaluating BECCS projects. Seller claims a third party LCA is underway. No public details are availble regarding proposed siting for this project, nor specific storage strategies. There is not enough information to calculate negativity.',
          removal: 'N/A',
          emissions: 'N/A',
          kind: 'N/A',
        },
        {
          ...
          notes: 'Seller claims 10,000 year permanence.',
          comment:
            'Seller claims captured CO2 will be stored bia mineralization of injection into saline aquifers in the north sea. Successful geologic sequestration produces reliable, effectively permanent carbon storage. However, there is not enough project information avialable to evaluate the permanence claim.',
        },
        {
          type: 'Metric',
          name: 'additionality',
        ...
        },
        {
          ...
          notes: '',
          comment:
            'Few project details are avialable. Crucial elements, such as project site and storage strategy, remain undefined.',
        },
      ],
      geometry: { type: null },
      tags: ['biomass', 'injection'],
      ...
      location: { name: 'N/A', geometry: { type: null } },
      source: {
        name: 'Microsoft 2021 CDR RFP',
        license: 'CC-BY-4.97',
        url: 'https://www.microsoft.com/en-us/',
    ...
    {
      type: 'Project',
      name: 'Jubilaci\u00f3n Segura Agroforestry and Reforestation',
      metrics: [
        {
          type: 'Metric',
          name: 'mechanism',
    ...
    },
    {
      ...
      metrics: [
        ...
        },
        {
          ...
          rating: 0.0,
          notes:
            'Seller offers 20,000 tCO2 removal from the addition of CCS to an unspecified facility, operated from 2022 onward.',
          comment: 'There is not enough information to validate this volume.',
        },
        {
          type: 'Metric',
    ...
    },
    {
      ...
      applicant: 'EDF Trading Limited',
      location: { name: 'Zambia', geometry: { type: null } },
      source: {
        name: 'Microsoft 2021 CDR RFP',
        license: 'CC-BY-4.102',
        url: 'https://www.microsoft.com/en-us/',
    ...
    },
    {
      ...
      location: { name: 'Spain ', geometry: { type: null } },
      source: {
        name: 'Microsoft 2021 CDR RFP',
        license: 'CC-BY-4.105',
        url: 'https://www.microsoft.com/en-us/',
    ...
    {
      type: 'Project',
      name: 'Clinch Valley Conservation Forestry Program \u2013 Rich Mtn',
      metrics: [
        {
          type: 'Metric',
          name: 'mechanism',
    ...
    },
    {
      ...
      metrics: [
        ...
        },
        {
          ...
          units: '',
          rating: -9999,
          notes: 'Counterfactual is no planting activity on project area.',
          comment: '',
        },
        {
          type: 'Metric',
    ...
    },
    {
      ...
      applicant: 'The Nature Conservancy',
      location: { name: 'USA, Belize, Carribean ', geometry: { type: null } },
      source: {
        name: 'Microsoft 2021 CDR RFP',
        license: 'CC-BY-4.110',
        url: 'https://www.microsoft.com/en-us/',
    ...
    },
    {
      ...
      location: { name: 'Norway', geometry: { type: null } },
      source: {
        name: 'Microsoft 2021 CDR RFP',
        license: 'CC-BY-4.116',
        url: 'https://www.microsoft.com/en-us/',
    ...
    {
      type: 'Project',
      name: 'Australia Regenerative Agriclture and Rotational Grazing ',
      metrics: [
        {
          type: 'Metric',
          name: 'mechanism',
    ...
    {
      type: 'Project',
      name: 'India Mangrove Afforestation',
      metrics: [
        {
          type: 'Metric',
          name: 'mechanism',
    ...
    },
    {
      ...
      location: { name: 'Germany', geometry: { type: null } },
      source: {
        name: 'Microsoft 2021 CDR RFP',
        license: 'CC-BY-4.123',
        url: 'https://www.microsoft.com/en-us/',
    ...
    {
      type: 'Project',
      name: 'Orangutan Habitat Restoration ',
      metrics: [
        {
          type: 'Metric',
          name: 'mechanism',
    ...
    },
    {
      ...
      metrics: [
        ...
        },
        {
          ...
          rating: -9999,
          notes:
            'Operation of biomass combined heat and power plant without carbon capture and storage (CCS).',
          comment:
            'This project is likely additional, but specifics depend on the economics of any applicable tax credits or policy incentives.',
        },
        {
    ...
    },
    {
      ...
      applicant: 'ClimateCare Oxford Ltd.',
      location: { name: 'France', geometry: { type: null } },
      source: {
        name: 'Microsoft 2021 CDR RFP',
        license: 'CC-BY-4.132',
        url: 'https://www.microsoft.com/en-us/',
    ...
    },
    {
      ...
      applicant: 'ClimateCare Oxford Ltd',
      location: {
        name: 'Mali, Burkina Faso, Ghana, Niger, & Ethiopia',
        geometry: { type: null },
      },
      source: {
        name: 'Microsoft 2021 CDR RFP',
    ...
    {
      type: 'Project',
      name: 'CommuniTree Carbon Program',
      metrics: [
        {
          type: 'Metric',
          name: 'mechanism',
    ...
    },
    {
      ...
      location: {
        name: 'Dominican Republic, Colombia, & Guatemala',
        geometry: { type: null },
      },
      source: {
        name: 'Microsoft 2021 CDR RFP',
    ...
    },
    {
      ...
      applicant: 'ClimateCare Oxford Ltd',
      location: { name: 'Nigeria', geometry: { type: null } },
      source: {
        name: 'Microsoft 2021 CDR RFP',
        license: 'CC-BY-4.138',
        url: 'https://www.microsoft.com/en-us/',
    ...
    {
      type: 'Project',
      name: 'Livelihoods Carbon Fund 3',
      metrics: [
        {
          type: 'Metric',
          name: 'mechanism',
    ...
    },
    {
      ...
      applicant: 'Compensate Foundation (Kompens\u00e4\u00e4ti\u00f6 sr)',
      location: { name: 'Global ', geometry: { type: null } },
      source: {
        name: 'Microsoft 2021 CDR RFP',
        license: 'CC-BY-4.142',
        url: 'https://www.microsoft.com/en-us/',
    ...
    },
    {
      ...
      metrics: [
        ...
        },
        {
          ...
          comment:
            'No data or analysis of is available to verify this negativity.',
          removal: 1.0,
          emissions: 0.008,
          kind: 'ratio',
        },
        ...
        },
        {
          ...
          notes: '',
          comment:
            'No commercial value to permanently storing harvested biomass. Specific project details are lacking, making an evaluation of additionality difficult.',
        },
        {
          type: 'Metric',
          name: 'cost',
    ...
    },
    {
      ...
      location: {
        name: 'North Dakota & South Dakota, USA',
        geometry: { type: null },
      },
      source: {
        name: 'Microsoft 2021 CDR RFP',
    ...
    },
    {
      ...
      metrics: [
        ...
        },
        {
          ...
          notes: '',
          comment:
            'High-level descriptions of project and technology are available. Specific publications or public data on demonstration projects are not available.',
        },
      ],
      geometry: { type: null },
      tags: ['ocean'],
    ...
    {
      type: 'Project',
      name: 'Peruvian Amazon Restoration',
      metrics: [
        {
          type: 'Metric',
          name: 'mechanism',
    ...
    {
      type: 'Project',
      name: 'Orinocense foothills Soil Carbon',
      metrics: [
        {
          type: 'Metric',
          name: 'mechanism',
    ...
    },
    {
      ...
      applicant: 'The Nature Conservancy',
      location: {
        name: 'Louisiana, Mississippi, & Arkansas, USA',
        geometry: { type: null },
      },
      source: {
        name: 'Microsoft 2021 CDR RFP',
    ...
    {
      type: 'Project',
      name: 'Sterling Planet Soil Carbon ',
      metrics: [
        {
          type: 'Metric',
          name: 'mechanism',
      ...
      location: { name: 'Northeast, USA', geometry: { type: null } },
      source: {
        name: 'Microsoft 2021 CDR RFP',
        license: 'CC-BY-4.155',
        url: 'https://www.microsoft.com/en-us/',
    ...
    },
    {
      ...
      location: { name: 'Costa Rica ', geometry: { type: null } },
      source: {
        name: 'Microsoft 2021 CDR RFP',
        license: 'CC-BY-4.158',
        url: 'https://www.microsoft.com/en-us/',
    ...
    {
      type: 'Project',
      name: 'Great Mountain Forest IFM',
      metrics: [
        {
          type: 'Metric',
          name: 'mechanism',
    ...
    {
      type: 'Project',
      name: 'Kibale National Park Restoration',
      metrics: [
        {
          type: 'Metric',
          name: 'mechanism',
    ...
    },
    {
      ...
      metrics: [
        ...
        },
        {
          ...
          notes: 'No counterfactual is specified.',
          comment:
            'No public information is available about the baseline against which this project is credited. As an investment in a specific quantity of carbon removal, there are concerns about double-counting, as the landowners may attempt to separately monetize the same carbon benefits using a carbon offset protocol.',
        },
        {
          type: 'Metric',
          name: 'cost',
      ...
      location: {
        name: 'Wisconsin & New Hampshire, USA',
        geometry: { type: null },
      },
      source: {
        name: 'Microsoft 2021 CDR RFP',
    ...
    {
      type: 'Project',
      name: '"Guanar\u00e9" Forest Plantations ',
      metrics: [
        {
          type: 'Metric',
          name: 'mechanism',
    ...
    },
    {
      ...
      applicant: 'Natural Capital Partners Americas, LLC',
      location: { name: 'Scotland & England', geometry: { type: null } },
      source: {
        name: 'Microsoft 2021 CDR RFP',
        license: 'CC-BY-4.168',
        url: 'https://www.microsoft.com/en-us/',
    ...
    },
    {
      ...
      location: {
        name: 'Pacific Ocean (near Hawaii)',
        geometry: { type: null },
      },
      source: {
        name: 'Microsoft 2021 CDR RFP',
    ...
    {
      type: 'Project',
      name: 'Chaco Pongamia Reforestaion',
      metrics: [
        {
          type: 'Metric',
          name: 'mechanism',
      ...
      location: { name: 'Uraguay', geometry: { type: null } },
      source: {
        name: 'Microsoft 2021 CDR RFP',
        license: 'CC-BY-4.172',
        url: 'https://www.microsoft.com/en-us/',
    ...
    {
      type: 'Project',
      name: 'Pematang Gadung Forest Restoration',
      metrics: [
        {
          type: 'Metric',
          name: 'mechanism',
          ...
          rating: 1.0,
          notes:
            'Project removes carbon from atmosphere for storage in forests, and avoids emissions.',
          comment: 'Project restores natural forest cover.',
          removal: 1.0,
          avoided: 1.0,
        },
        {
          ...
          rating: 0.0,
          notes:
            'Seller offers 200,328 tCO2 removal from an unspecified project area. The offered volume is just a portion of the total carbon benefits attributed to the project. A 20% buffer is maintained to mitigate against reversals.',
          comment:
            'Project claims to take plots with inital standing stock of 50-100 tCO2/ha to 150 tCO2/ha over the 25 year project term. This appears to be done through payments to local communities to cease harvest for the first 15 years, allowing natural regeneration, and doing some active planting. Project implementation specifics are not clearly documented.',
        },
        {
          type: 'Metric',
          name: 'negativity',
    ...
    {
      type: 'Project',
      name: 'Regen Soil Organic Carbon at Wangella Pastoral Pty Ltd.',
      metrics: [
        {
          type: 'Metric',
          name: 'mechanism',
    ...
    {
      type: 'Project',
      name: 'Regen Soil Organic Carbon at Woodburn',
      metrics: [
        {
          type: 'Metric',
          name: 'mechanism',
    ...
    {
      type: 'Project',
      name: 'Regen Soil Organic Carbon at Cavan Station',
      metrics: [
        {
          type: 'Metric',
          name: 'mechanism',
    ...
    {
      type: 'Project',
      name: 'Regen Soil Organic Carbon at  at Wilmot Cattle Co.',
      metrics: [
        {
          type: 'Metric',
          name: 'mechanism',
    ...
    {
      type: 'Project',
      name: 'Running Tide Kelp Farming ',
      metrics: [
        {
          type: 'Metric',
          name: 'mechanism',
        ...
        },
        {
          ...
          notes: '',
          comment:
            'Reasonably thorough description of technology with references. Specific publications or public data from the feasibility study are upcoming.',
        },
      ],
      geometry: { type: null },
      tags: ['ocean'],
      ...
      location: { name: 'Atlantic Ocean ', geometry: { type: null } },
      source: {
        name: 'Microsoft 2021 CDR RFP',
        license: 'CC-BY-4.182',
        url: 'https://www.microsoft.com/en-us/',
    ...
    {
      type: 'Project',
      name: 'Soil Value Exchange Grasslands ',
      metrics: [
        {
          type: 'Metric',
          name: 'mechanism',
    ...
    {
      type: 'Project',
      name: 'EcoTree Private Forest Project ',
      metrics: [
        {
          type: 'Metric',
          name: 'mechanism',
      ...
      tags: ['forests', 'reforestation'],
      id: 'MSFT186',
      description: 'Private forest raising project.',
    ...
    },
    {
      ...
      location: { name: 'Colorado, USA', geometry: { type: null } },
      source: {
        name: 'Microsoft 2021 CDR RFP',
        license: 'CC-BY-4.187',
        url: 'https://www.microsoft.com/en-us/',
    ...
    {
      type: 'Project',
      name: 'Saving Nature Wildlife Corridors',
      metrics: [
        {
          type: 'Metric',
          name: 'mechanism',
      ...
      location: { name: 'Brazil, Colombia', geometry: { type: null } },
      source: {
        name: 'Microsoft 2021 CDR RFP',
        license: 'CC-BY-4.188',
        url: 'https://www.microsoft.com/en-us/',
