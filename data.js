module.exports = {
  ...
  projects: [
    ...
    },
    {
      ...
      id: 'STRP016',
      description: 'Net-negative insulation and wood products.',
      applicant: 'Ekovilla',
      rating: '2',
      keywords: '',
    ...
    },
    {
      ...
      metrics: [
        ...
        },
        {
          ...
          rating: 0.0,
          notes:
            'Reported ratio based on 0.35 tCO2 emitted for 1.55 tCO2 sequestered, including emissions due to bio-oil production, transporation to well, and injection.',
          comment:
    ...
    },
    {
      ...
      id: 'MSFT076',
      description:
        'Enhancing rangeland soil health and carbon sequestration with compost. ',
      applicant: '3Degrees ',
      rating: '1',
      keywords: '',
      location: { name: 'California, USA' },
    ...
    },
    {
      ...
      metrics: [
        ...
        },
        {
          ...
          comment:
            'For consistency, we compute negativity only for the carbon mineralization component. LCA boundary conditions for the numbers provided in this proposal are well-specified. Although third-party audits of the LCA analysis seem to have been performed, no documentation or validation is available. Also note, that the negativity reported in this proposal is a higher ratio than previously reported.',
          removal: 0.9,
          emissions: 0.063,
        },
        {
        ...
        },
        {
          ...
          notes: '',
          comment:
            'Cement will already be purchased and used separate from its carbon removal benefits.',
        },
        {
          type: 'Metric',
          name: 'cost',
    ...
    },
    {
      ...
      id: 'MSFT061',
      description:
        'Community reforestation and agroforestry through the Aprosacao Reforestation Project by PUR Projet.',
      applicant: 'ClimateCare Oxford',
      rating: '1',
    ...
    },
    {
      ...
      metrics: [
        ...
        },
        {
          ...
          notes: 'Counterfactual is reforesting manually or not at all.',
          comment:
            'This offer is an opportunity to subsidize reforestation for private landowners by buying carbon removal futures. The extent of project area and associated carbon benefits are subject to landowner decision-making. More information regarding the impact of a carbon-finance subsidy on the extent of reforestation would be useful for analyzing additionality. Project indicates plans to confer carbon benefits through the ClimateForward protocol.',
        },
        {
          type: 'Metric',
          name: 'cost',
    ...
    },
    {
      ...
      metrics: [
        ...
        },
        {
          ...
          comment:
            'Few details available on specific deployment plan. Some combination of volume of olivine and timeline of credited removal would be needed to validate the volume.',
        },
        {
          type: 'Metric',
          name: 'negativity',
    ...
    },
    {
      ...
      metrics: [
        ...
        },
        {
          ...
          comment:
            'A specific deployment plan for this singe-chance purchase is not specified. Both application to soils and application along railroads are mentioned. Seller claims to sell only the first ten years of carbon benefits from this olivine deployment, but claims a total estimated sequestration of 6428 tCO2. Given plausible ranges of olivine sequestration, this could correspond to anywhere from 6140 -10,540 t olivine deployed.',
        },
        {
          type: 'Metric',
          name: 'negativity',
      ...
      metrics: [
        {
          ...
          notes:
            'Project removes carbon from atmosphere for storage in timber plantations.',
          comment:
            'Project plants commercial timber plantations of Eucalyptus pellita, Acacia mangium and Gmelina arborea with <10 year harvest cycles.',
          removal: 1.0,
          avoided: 0.0,
        },
        {
          ...
          rating: 1.0,
          notes:
            'Seller offers 745,374 tCO2 removal from previous and future plantation growth. The offered volume is just a portion of the total carbon benefits attributed to the project. An 18% buffer is maintained to mitigate against reversals.',
          comment:
            'Plantation area is currently 4020 ha, and is projected to expand 1500 ha/year from 2020-2025. Per-species planting and growth assumptions are well-cited and fall within plausible ranges. Project includes carbon removal attributed to soil.',
        },
        {
          type: 'Metric',
          name: 'negativity',
        ...
        },
        {
          ...
          units: 'years',
          rating: 1.0,
          notes: 'Seller claims 30 year permance.',
          comment:
            'Project lifetime appears to be 20 years (2016-2045) with 26 years remaining from date of review, which we report as the permanence.',
        },
        {
          type: 'Metric',
          name: 'additionality',
          ...
          notes: '',
          comment:
            'Project implementor has been engaging in commercial plantation forestry in Sierra Leone since 2012. This offer in currently seeking to recieve credits for plantation growth from 2016 onward.',
        },
        {
          type: 'Metric',
          name: 'cost',
        ...
        },
        {
          ...
          notes: '',
          comment:
            'Significant project information available through the Verra registry.',
        },
      ],
      tags: ['forests', 'reforestation'],
      id: 'MSFT040',
      description:
        'Plantation forestry for sustinable timber harvesting and reforestation.',
      applicant: 'South Pole ',
      rating: '2',
      keywords: '',
      location: { name: 'Sierra Leone' },
